...
<body>
    ...
    <script src="<?php base_url('assets/vendors/progressbar.js/progressbar.min.js') ?>"></script>
    <script src="<?php base_url('assets/vendors/jvectormap/jquery-jvectormap.min.js') ?>"></script>
    <script src="<?php base_url('assets/vendors/jvectormap/jquery-jvectormap-world-mill-en.js') ?>"></script>
    <script src="<?php base_url('assets/vendors/owl-carousel-2/owl.carousel.min.js') ?>"></script>
    ...
    <script>
      function previewktp(){
        ...
        const labelktp = document.querySelector('.custom-file-label');
        const ktpPreview = document.querySelector('.viewktp')

        labelktp.textContent = ktp.files[0].name;
